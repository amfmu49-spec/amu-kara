(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52683,e=>{"use strict";var t=e.i(47167),r=e.i(43476),n=e.i(71645);function i({audioUrl:e,bgImageUrl:t,lyrics:o,title:a,onReset:l}){let s=(0,n.useRef)(null),[c,d]=(0,n.useState)(0),[p,x]=(0,n.useState)(0),[u,f]=(0,n.useState)(!1),[h,g]=(0,n.useState)(0),[b,m]=(0,n.useState)(!0),y=(0,n.useRef)(null),v=(0,n.useRef)(null),w=(0,n.useRef)(null),S=(0,n.useRef)(null),j=o.map(e=>{let t=e.text.replace(/\[.*?\]/g,"").replace(/\(.*?\)/g,"").trim();return{...e,text:t}}).filter(e=>e.text.length>0);(0,n.useEffect)(()=>{s.current&&(()=>{try{y.current||(y.current=new(window.AudioContext||window.webkitAudioContext));let e=y.current;if("suspended"===e.state&&e.resume(),!v.current&&s.current){v.current=e.createMediaElementSource(s.current);let t=e.createChannelSplitter(2),r=e.createChannelMerger(2),n=e.createGain();n.gain.value=.5;let i=e.createGain();i.gain.value=.5;let o=e.createGain();o.gain.value=-.5;let a=e.createBiquadFilter();a.type="notch",a.frequency.value=1200,a.Q.value=2.2;let l=e.createBiquadFilter();l.type="peaking",l.frequency.value=2800,l.Q.value=2,l.gain.value=-24;let c=e.createBiquadFilter();c.type="lowshelf",c.frequency.value=120,c.gain.value=4;let d=e.createBiquadFilter();d.type="highshelf",d.frequency.value=7e3,d.gain.value=4,w.current=a,S.current=l,v.current.connect(t),t.connect(n,0),t.connect(n,1),n.connect(a),a.connect(l),t.connect(i,0),t.connect(o,1),i.connect(c),o.connect(c),c.connect(d),l.connect(r,0,0),l.connect(r,0,1),d.connect(r,0,0);let p=e.createGain();p.gain.value=-1,d.connect(p),p.connect(r,0,1),r.connect(e.destination)}w.current&&S.current&&(b?S.current.gain.value=-24:S.current.gain.value=0)}catch(e){console.warn("Web Audio API setup fallback:",e)}})()},[b]),(0,n.useEffect)(()=>{if(s.current){let e=Math.pow(2,h/12);s.current.playbackRate=e;let t=s.current;"preservesPitch"in t&&(t.preservesPitch=!1),"mozPreservesPitch"in t&&(t.mozPreservesPitch=!1),"webkitPreservesPitch"in t&&(t.webkitPreservesPitch=!1)}},[h]);let k=j.findIndex(e=>c>=e.startTime&&c<=e.endTime),I=k>=0?j[k]:null,C=k>=0&&k+1<j.length?j[k+1]:null;if(!I&&j.length>0){let e=j.findIndex(e=>e.startTime>c);e>=0?C=j[e]:I=j[j.length-1]}let R=e=>{let t=Math.floor(e/60),r=Math.floor(e%60);return`${t}:${r<10?"0":""}${r}`};return(0,r.jsxs)("div",{style:{position:"relative",width:"100%",minHeight:"100vh",backgroundColor:"#0f172a",color:"#ffffff",display:"flex",flexDirection:"column",justifyContent:"space-between",overflow:"hidden",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'},children:[(0,r.jsxs)("div",{style:{position:"absolute",inset:0,pointerEvents:"none"},children:[t?(0,r.jsx)("img",{src:t,alt:"Song Cover",style:{width:"100%",height:"100%",objectFit:"cover",filter:"blur(30px) brightness(0.4)",transform:"scale(1.1)"}}):(0,r.jsx)("div",{style:{width:"100%",height:"100%",background:"radial-gradient(circle at center, #1e1b4b 0%, #0f172a 100%)"}}),(0,r.jsx)("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(15, 23, 42, 0.6) 0%, rgba(15, 23, 42, 0.95) 100%)"}})]}),(0,r.jsxs)("header",{style:{position:"relative",zIndex:10,padding:"16px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",borderBottom:"1px solid rgba(255, 255, 255, 0.1)",backdropFilter:"blur(12px)",backgroundColor:"rgba(15, 23, 42, 0.7)"},children:[(0,r.jsx)("button",{type:"button",onClick:l,style:{background:"none",border:"none",color:"#cbd5e1",fontSize:"14px",fontWeight:"bold",cursor:"pointer",display:"flex",alignItems:"center",gap:"4px"},children:"← 戻る"}),(0,r.jsx)("div",{style:{textAlign:"center",maxWidth:"55%"},children:(0,r.jsx)("h1",{style:{fontSize:"15px",fontWeight:"bold",color:"#ffffff",margin:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:a||"AMU KARA"})}),(0,r.jsx)("button",{type:"button",onClick:()=>m(!b),style:{padding:"6px 14px",borderRadius:"20px",fontSize:"11px",fontWeight:"bold",border:"none",cursor:"pointer",background:b?"linear-gradient(90deg, #ec4899, #a855f7)":"#475569",color:"#ffffff",boxShadow:b?"0 0 12px rgba(236, 72, 153, 0.5)":"none"},children:b?"🎤 ボーカル消去: ON":"🎤 原曲: OFF"})]}),(0,r.jsxs)("div",{style:{position:"relative",zIndex:10,flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 20px",textAlign:"center"},children:[t&&(0,r.jsx)("img",{src:t,alt:"Track Artwork",style:{width:"110px",height:"110px",borderRadius:"20px",objectFit:"cover",boxShadow:"0 10px 30px rgba(236, 72, 153, 0.3)",marginBottom:"32px",border:"2px solid rgba(255, 255, 255, 0.2)"}}),(0,r.jsxs)("div",{style:{width:"100%",maxWidth:"560px",backgroundColor:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(236, 72, 153, 0.3)",borderRadius:"24px",padding:"28px 20px",backdropFilter:"blur(16px)",boxShadow:"0 20px 50px rgba(0, 0, 0, 0.5)",display:"flex",flexDirection:"column",alignItems:"center",gap:"16px",boxSizing:"border-box"},children:[(0,r.jsx)("div",{style:{minHeight:"60px",display:"flex",alignItems:"center",justifyContent:"center"},children:I?(0,r.jsx)("p",{style:{fontSize:"26px",fontWeight:"900",margin:0,lineHeight:"1.4",background:"linear-gradient(90deg, #f472b6, #38bdf8, #ffffff)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",filter:"drop-shadow(0 2px 10px rgba(236, 72, 153, 0.5))",transform:"scale(1.05)",transition:"all 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275)"},children:I.text}):(0,r.jsx)("p",{style:{fontSize:"18px",color:"#64748b",margin:0,fontStyle:"italic"},children:"🎵 演奏中..."})}),C&&(0,r.jsxs)("div",{style:{borderTop:"1px dashed rgba(255, 255, 255, 0.15)",paddingTop:"12px",width:"80%",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px"},children:[(0,r.jsx)("span",{style:{fontSize:"11px",color:"#38bdf8",fontWeight:"bold"},children:"NEXT▶"}),(0,r.jsx)("p",{style:{fontSize:"15px",fontWeight:"600",color:"#94a3b8",margin:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:C.text})]})]})]}),(0,r.jsxs)("footer",{style:{position:"relative",zIndex:10,padding:"20px 24px 32px 24px",backgroundColor:"rgba(15, 23, 42, 0.85)",backdropFilter:"blur(20px)",borderTop:"1px solid rgba(255, 255, 255, 0.1)",display:"flex",flexDirection:"column",gap:"16px"},children:[(0,r.jsxs)("div",{style:{width:"100%",display:"flex",flexDirection:"column",gap:"6px"},children:[(0,r.jsx)("input",{type:"range",min:0,max:p||100,value:c,onChange:e=>{let t=parseFloat(e.target.value);d(t),s.current&&(s.current.currentTime=t)},style:{width:"100%",accentColor:"#ec4899",cursor:"pointer"}}),(0,r.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",fontSize:"11px",color:"#94a3b8",fontWeight:"bold"},children:[(0,r.jsx)("span",{children:R(c)}),(0,r.jsx)("span",{children:R(p)})]})]}),(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 8px"},children:[(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px",background:"rgba(30, 41, 59, 0.8)",padding:"6px 12px",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)"},children:[(0,r.jsx)("span",{style:{fontSize:"11px",fontWeight:"bold",color:"#cbd5e1"},children:"キー:"}),(0,r.jsx)("button",{type:"button",onClick:()=>g(e=>Math.max(-6,e-1)),style:{width:"28px",height:"28px",borderRadius:"50%",border:"none",background:"#334155",color:"#ffffff",fontWeight:"bold",fontSize:"14px",cursor:"pointer"},children:"-"}),(0,r.jsx)("span",{style:{fontSize:"13px",fontWeight:"bold",color:0===h?"#ffffff":"#f472b6",minWidth:"24px",textAlign:"center"},children:h>0?`+${h}`:h}),(0,r.jsx)("button",{type:"button",onClick:()=>g(e=>Math.min(6,e+1)),style:{width:"28px",height:"28px",borderRadius:"50%",border:"none",background:"#334155",color:"#ffffff",fontWeight:"bold",fontSize:"14px",cursor:"pointer"},children:"+"})]}),(0,r.jsx)("button",{type:"button",onClick:()=>{s.current&&(y.current&&"suspended"===y.current.state&&y.current.resume(),u?(s.current.pause(),f(!1)):(s.current.play(),f(!0)))},style:{width:"64px",height:"64px",borderRadius:"50%",border:"none",background:"linear-gradient(135deg, #ec4899 0%, #a855f7 100%)",color:"#ffffff",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",boxShadow:"0 8px 25px rgba(236, 72, 153, 0.5)",transition:"transform 0.2s ease"},children:u?(0,r.jsxs)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",children:[(0,r.jsx)("rect",{x:"6",y:"4",width:"4",height:"16",rx:"2"}),(0,r.jsx)("rect",{x:"14",y:"4",width:"4",height:"16",rx:"2"})]}):(0,r.jsx)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",style:{marginLeft:"4px"},children:(0,r.jsx)("path",{d:"M8 5v14l11-7z"})})}),(0,r.jsx)("div",{style:{width:"80px"}})]})]}),(0,r.jsx)("audio",{ref:s,src:e,crossOrigin:"anonymous",onTimeUpdate:()=>{s.current&&d(s.current.currentTime)},onLoadedMetadata:()=>{s.current&&x(s.current.duration)},onEnded:()=>f(!1),autoPlay:!0})]})}function o(e){if(!e||!e.trim())return[];let t=e.replace(/\r\n/g,"\n").replace(/\r/g,"\n").trim().split(/\n\n+/),r=[],n=1;for(let e of t){let t=e.trim().split("\n");if(t.length<2)continue;let i="",o=[];if(t[0].includes("-->"))i=t[0],o=t.slice(1);else{if(!(t[1]&&t[1].includes("-->")))continue;i=t[1],o=t.slice(2)}let l=i.split("-->");if(2!==l.length)continue;let s=a(l[0].trim()),c=a(l[1].trim()),d=o.join(" ").trim();if((d=d.replace(/\[.*?\]/g,"").replace(/\(.*?\)/g,"").trim())&&d.length>0){let e=r[r.length-1];e&&e.text===d&&.5>Math.abs(e.startTime-s)?e.endTime=Math.max(e.endTime,c):r.push({id:n++,startTime:s,endTime:c,text:d})}}return r}function a(e){let t=e.match(/(\d{2}):(\d{2}):(\d{2})[,.](\d{3})/);return t?3600*parseInt(t[1],10)+60*parseInt(t[2],10)+parseInt(t[3],10)+parseInt(t[4],10)/1e3:0}let l=e=>`javascript:(function(){
  try {
