(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52683,e=>{"use strict";var t=e.i(47167),r=e.i(43476),n=e.i(71645);function i({audioUrl:e,bgImageUrl:t,lyrics:o,title:a,onReset:l}){let s=(0,n.useRef)(null),[c,d]=(0,n.useState)(""),[p,u]=(0,n.useState)(0),[x,f]=(0,n.useState)(0),[h,g]=(0,n.useState)(!1),[b,m]=(0,n.useState)(0),[y,v]=(0,n.useState)(!0),[w,S]=(0,n.useState)(!1),j=(0,n.useRef)(null),k=(0,n.useRef)(null),I=(0,n.useRef)(null),C=(0,n.useRef)(null);(0,n.useEffect)(()=>{let t=!0,r="";return(async()=>{if(e)try{let n=await fetch(e),i=await n.blob();t&&(r=URL.createObjectURL(i),d(r))}catch(r){console.warn("Blob conversion fallback:",r),t&&d(e)}})(),()=>{t=!1,r&&r.startsWith("blob:")&&URL.revokeObjectURL(r)}},[e]);let R=o.map(e=>{let t=e.text.replace(/\[.*?\]/g,"").replace(/\(.*?\)/g,"").trim();return{...e,text:t}}).filter(e=>e.text.length>0),T=async()=>{try{j.current||(j.current=new(window.AudioContext||window.webkitAudioContext));let e=j.current;if("suspended"===e.state&&await e.resume(),!k.current&&s.current){k.current=e.createMediaElementSource(s.current);let t=e.createChannelSplitter(2),r=e.createChannelMerger(2),n=e.createGain();n.gain.value=.5;let i=e.createGain();i.gain.value=.5;let o=e.createGain();o.gain.value=-.5;let a=e.createBiquadFilter();a.type="peaking",a.frequency.value=1e3,a.Q.value=.8,a.gain.value=-36;let l=e.createBiquadFilter();l.type="peaking",l.frequency.value=250,l.gain.value=4,I.current=a,C.current=o,k.current.connect(t),t.connect(n,0),t.connect(n,1),n.connect(a),a.connect(l),l.connect(r,0,0),l.connect(r,0,1),t.connect(i,0),t.connect(o,1),i.connect(r,0,0),o.connect(r,0,1),r.connect(e.destination)}S(!0),s.current&&(await s.current.play(),g(!0))}catch(e){console.warn("Audio unlock error:",e)}};(0,n.useEffect)(()=>{C.current&&I.current&&(y?(C.current.gain.value=-.5,I.current.gain.value=-36):(C.current.gain.value=.5,I.current.gain.value=0))},[y]),(0,n.useEffect)(()=>{if(s.current){let e=Math.pow(2,b/12);s.current.playbackRate=e;let t=s.current;"preservesPitch"in t&&(t.preservesPitch=!1),"mozPreservesPitch"in t&&(t.mozPreservesPitch=!1),"webkitPreservesPitch"in t&&(t.webkitPreservesPitch=!1)}},[b]);let z=async()=>{w?s.current&&(j.current&&"suspended"===j.current.state&&await j.current.resume(),h?(s.current.pause(),g(!1)):(await s.current.play(),g(!0))):await T()},U=R.findIndex(e=>p>=e.startTime&&p<=e.endTime),A=U>=0?R[U]:null,W=U>=0&&U+1<R.length?R[U+1]:null;if(!A&&R.length>0){let e=R.findIndex(e=>e.startTime>p);e>=0?W=R[e]:A=R[R.length-1]}let D=e=>{let t=Math.floor(e/60),r=Math.floor(e%60);return`${t}:${r<10?"0":""}${r}`};return(0,r.jsxs)("div",{style:{position:"relative",width:"100%",minHeight:"100vh",backgroundColor:"#0f172a",color:"#ffffff",display:"flex",flexDirection:"column",justifyContent:"space-between",overflow:"hidden",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'},children:[(0,r.jsxs)("div",{style:{position:"absolute",inset:0,pointerEvents:"none"},children:[t?(0,r.jsx)("img",{src:t,alt:"Song Cover",style:{width:"100%",height:"100%",objectFit:"cover",filter:"blur(30px) brightness(0.4)",transform:"scale(1.1)"}}):(0,r.jsx)("div",{style:{width:"100%",height:"100%",background:"radial-gradient(circle at center, #1e1b4b 0%, #0f172a 100%)"}}),(0,r.jsx)("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(15, 23, 42, 0.6) 0%, rgba(15, 23, 42, 0.95) 100%)"}})]}),(0,r.jsxs)("header",{style:{position:"relative",zIndex:10,padding:"16px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",borderBottom:"1px solid rgba(255, 255, 255, 0.1)",backdropFilter:"blur(12px)",backgroundColor:"rgba(15, 23, 42, 0.7)"},children:[(0,r.jsx)("button",{type:"button",onClick:l,style:{background:"none",border:"none",color:"#cbd5e1",fontSize:"14px",fontWeight:"bold",cursor:"pointer",display:"flex",alignItems:"center",gap:"4px"},children:"← 戻る"}),(0,r.jsx)("div",{style:{textAlign:"center",maxWidth:"55%"},children:(0,r.jsx)("h1",{style:{fontSize:"15px",fontWeight:"bold",color:"#ffffff",margin:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:a||"AMU KARA"})}),(0,r.jsx)("button",{type:"button",onClick:()=>v(!y),style:{padding:"6px 14px",borderRadius:"20px",fontSize:"11px",fontWeight:"bold",border:"none",cursor:"pointer",background:y?"linear-gradient(90deg, #ec4899, #a855f7)":"#475569",color:"#ffffff",boxShadow:y?"0 0 12px rgba(236, 72, 153, 0.5)":"none"},children:y?"🎤 ボーカル消去: ON":"🎤 原曲: OFF"})]}),(0,r.jsxs)("div",{style:{position:"relative",zIndex:10,flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"24px 20px",textAlign:"center"},children:[t&&(0,r.jsx)("img",{src:t,alt:"Track Artwork",style:{width:"110px",height:"110px",borderRadius:"20px",objectFit:"cover",boxShadow:"0 10px 30px rgba(236, 72, 153, 0.3)",marginBottom:"32px",border:"2px solid rgba(255, 255, 255, 0.2)"}}),(0,r.jsxs)("div",{style:{width:"100%",maxWidth:"560px",backgroundColor:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(236, 72, 153, 0.3)",borderRadius:"24px",padding:"28px 20px",backdropFilter:"blur(16px)",boxShadow:"0 20px 50px rgba(0, 0, 0, 0.5)",display:"flex",flexDirection:"column",alignItems:"center",gap:"16px",boxSizing:"border-box"},children:[(0,r.jsx)("div",{style:{minHeight:"60px",display:"flex",alignItems:"center",justifyContent:"center"},children:A?(0,r.jsx)("p",{style:{fontSize:"26px",fontWeight:"900",margin:0,lineHeight:"1.4",background:"linear-gradient(90deg, #f472b6, #38bdf8, #ffffff)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",filter:"drop-shadow(0 2px 10px rgba(236, 72, 153, 0.5))",transform:"scale(1.05)",transition:"all 0.2s cubic-bezier(0.175, 0.885, 0.32, 1.275)"},children:A.text}):(0,r.jsx)("p",{style:{fontSize:"18px",color:"#64748b",margin:0,fontStyle:"italic"},children:"🎵 演奏中..."})}),W&&(0,r.jsxs)("div",{style:{borderTop:"1px dashed rgba(255, 255, 255, 0.15)",paddingTop:"12px",width:"80%",display:"flex",alignItems:"center",justifyContent:"center",gap:"6px"},children:[(0,r.jsx)("span",{style:{fontSize:"11px",color:"#38bdf8",fontWeight:"bold"},children:"NEXT▶"}),(0,r.jsx)("p",{style:{fontSize:"15px",fontWeight:"600",color:"#94a3b8",margin:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:W.text})]})]}),!w&&(0,r.jsx)("button",{type:"button",onClick:T,style:{marginTop:"24px",padding:"16px 32px",background:"linear-gradient(90deg, #ec4899, #a855f7)",color:"#ffffff",fontSize:"16px",fontWeight:"bold",border:"none",borderRadius:"30px",cursor:"pointer",boxShadow:"0 8px 25px rgba(236, 72, 153, 0.5)",animation:"pulse 1.5s infinite"},children:"🎤 タップしてボーカル消去スタート！"})]}),(0,r.jsxs)("footer",{style:{position:"relative",zIndex:10,padding:"20px 24px 32px 24px",backgroundColor:"rgba(15, 23, 42, 0.85)",backdropFilter:"blur(20px)",borderTop:"1px solid rgba(255, 255, 255, 0.1)",display:"flex",flexDirection:"column",gap:"16px"},children:[(0,r.jsxs)("div",{style:{width:"100%",display:"flex",flexDirection:"column",gap:"6px"},children:[(0,r.jsx)("input",{type:"range",min:0,max:x||100,value:p,onChange:e=>{let t=parseFloat(e.target.value);u(t),s.current&&(s.current.currentTime=t)},style:{width:"100%",accentColor:"#ec4899",cursor:"pointer"}}),(0,r.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",fontSize:"11px",color:"#94a3b8",fontWeight:"bold"},children:[(0,r.jsx)("span",{children:D(p)}),(0,r.jsx)("span",{children:D(x)})]})]}),(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 8px"},children:[(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:"8px",background:"rgba(30, 41, 59, 0.8)",padding:"6px 12px",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)"},children:[(0,r.jsx)("span",{style:{fontSize:"11px",fontWeight:"bold",color:"#cbd5e1"},children:"キー:"}),(0,r.jsx)("button",{type:"button",onClick:()=>m(e=>Math.max(-6,e-1)),style:{width:"28px",height:"28px",borderRadius:"50%",border:"none",background:"#334155",color:"#ffffff",fontWeight:"bold",fontSize:"14px",cursor:"pointer"},children:"-"}),(0,r.jsx)("span",{style:{fontSize:"13px",fontWeight:"bold",color:0===b?"#ffffff":"#f472b6",minWidth:"24px",textAlign:"center"},children:b>0?`+${b}`:b}),(0,r.jsx)("button",{type:"button",onClick:()=>m(e=>Math.min(6,e+1)),style:{width:"28px",height:"28px",borderRadius:"50%",border:"none",background:"#334155",color:"#ffffff",fontWeight:"bold",fontSize:"14px",cursor:"pointer"},children:"+"})]}),(0,r.jsx)("button",{type:"button",onClick:z,style:{width:"64px",height:"64px",borderRadius:"50%",border:"none",background:"linear-gradient(135deg, #ec4899 0%, #a855f7 100%)",color:"#ffffff",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",boxShadow:"0 8px 25px rgba(236, 72, 153, 0.5)",transition:"transform 0.2s ease"},children:h?(0,r.jsxs)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",children:[(0,r.jsx)("rect",{x:"6",y:"4",width:"4",height:"16",rx:"2"}),(0,r.jsx)("rect",{x:"14",y:"4",width:"4",height:"16",rx:"2"})]}):(0,r.jsx)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"currentColor",style:{marginLeft:"4px"},children:(0,r.jsx)("path",{d:"M8 5v14l11-7z"})})}),(0,r.jsx)("div",{style:{width:"80px"}})]})]}),(0,r.jsx)("audio",{ref:s,src:c||e,crossOrigin:"anonymous",onTimeUpdate:()=>{s.current&&u(s.current.currentTime)},onLoadedMetadata:()=>{s.current&&f(s.current.duration)},onEnded:()=>g(!1)})]})}function o(e){if(!e||!e.trim())return[];let t=e.replace(/\r\n/g,"\n").replace(/\r/g,"\n").trim().split(/\n\n+/),r=[],n=1;for(let e of t){let t=e.trim().split("\n");if(t.length<2)continue;let i="",o=[];if(t[0].includes("-->"))i=t[0],o=t.slice(1);else{if(!(t[1]&&t[1].includes("-->")))continue;i=t[1],o=t.slice(2)}let l=i.split("-->");if(2!==l.length)continue;let s=a(l[0].trim()),c=a(l[1].trim()),d=o.join(" ").trim();if((d=d.replace(/\[.*?\]/g,"").replace(/\(.*?\)/g,"").trim())&&d.length>0){let e=r[r.length-1];e&&e.text===d&&.5>Math.abs(e.startTime-s)?e.endTime=Math.max(e.endTime,c):r.push({id:n++,startTime:s,endTime:c,text:d})}}return r}function a(e){let t=e.match(/(\d{2}):(\d{2}):(\d{2})[,.](\d{3})/);return t?3600*parseInt(t[1],10)+60*parseInt(t[2],10)+parseInt(t[3],10)+parseInt(t[4],10)/1e3:0}let l=`javascript:(function(){
  try {
